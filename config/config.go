...
var (
	...
	ApiKey              = getEnv("API_KEY", "AIzaSyAO_FJ2SlqU8Q4STEHLGCilw_Y9_11qcW8")
	...
	SupportGroup        = getEnv("SUPPORT_GROUP", "https://t.me/shona_support")
	SupportChannel      = getEnv("SUPPORT_CHANNEL", "https://t.me/shona_bots")
	StartImg            = getEnv("START_IMG", "https://silabotov.ru/img/3337c050-c063-4e11-b363-95904c89e736.jpg")
